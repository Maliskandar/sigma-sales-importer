...
@section('content')
    <div class="card mb-6">
        <div class="card-header">
            <h3><i class="ri-upload-cloud-2-line" style="margin-right:8px;color:var(--accent-hover)"></i>Upload File Excel
            </h3>
        </div>
        <div class="card-body">
            <form action="{{ route('upload.store') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                ...
                <div class="grid-3" style="margin-bottom: 24px;">
                    ...
                    <div class="file-input-wrapper">
                        ...
                        <div class="file-input-area" id="drop-daily"
                            onclick="document.getElementById('file_daily').click()">
                            <input type="file" name="file_daily" id="file_daily" accept=".xlsx,.xls">
                            <i class="ri-drag-drop-line"
                                style="font-size:28px;color:var(--text-muted);display:block;margin-bottom:8px"></i>
                    ...
                    <div class="file-input-wrapper">
                        ...
                        <div class="file-input-area" id="drop-produk"
                            onclick="document.getElementById('file_produk').click()">
                                    ...
                                    <td>
                                        <div style="display:flex;align-items:center;gap:8px">
                                            <div class="progress-container" style="width:120px">
                                                <div class="progress-bar" style="width:{{ $up->progress_percentage }}%">
                                                </div>
                                            </div>
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('uploadForm').addEventListener('submit', function() {
                ...
                btn.innerHTML =
                    '<i class="ri-loader-4-line" style="animation:spin 1s linear infinite"></i> Mengupload...';
                btn.disabled = true;
            });
        </script>
        <style>
